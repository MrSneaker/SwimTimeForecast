...
from .train_v4 import train as train_v4
...
parser.add_argument("--model_version", choices=["v1", "v2", "v3", "v4"], default="v3",
                    help="Choose which model version to train/test (v1: LSTM, v2: FFN, v3: TFT (architecture adaptée), v4: TFT (architecture originale))")
...
if args.mode == "train":
    if args.model_version == "v3":
        ...
        train_v4(args.epochs, args.batch_size, args.use_optimized)
    else:
    ...
    test(save_figures=args.save_test_plots, model_version=args.model_version, use_optimized=args.use_optimized)
